...
@bridleway-fill: #8f8f8f;
@bridleway-fill-noaccess: #8f8f8f;
@track-fill: #b4b4b4;
...
@access-marking-living-street: #eaeaea;

@default-casing: white;
@tertiary-casing: #b0b0b0;
@residential-casing: #c1c1c1;
@road-casing: @residential-casing;
@service-casing: #c1c1c1;
@living-street-casing: @residential-casing;
@pedestrian-casing: #c1c1c1;
...
@destination-marking: #aaa;
@private-marking: #aaa;
@private-marking-for-red: #aaa;

@tunnel-casing: grey;
@bridge-casing: #8a8a8a;
...
*/
    ...
    [feature = 'railway_narrow_gauge'] {
      [zoom >= 8] {
        line-color: #cccccc;
        [zoom >= 10] { line-color: #cccccc; }
        [zoom >= 13] { line-color: #cccccc; }
        line-width: 1;
        [zoom >= 13] { line-width: 2; }
        #tunnels {
          line-dasharray: 5,3;
...
//[highway = 'construction'][construction = 'service'][zoom >= 17] {
    [zoom >= 16] {
      ...
      text-placement: line;
      text-halo-radius: @standard-halo-radius;
      [highway = 'raceway'] { text-halo-fill: @standard-halo-fill; }
      [highway = 'service'] { text-halo-fill: @standard-halo-fill; }
      text-face-name: @book-fonts;
      text-repeat-distance: @major-highway-text-repeat-distance;
    }
    [zoom >= 17] {
