...
@minor-construction: desaturate(#aaa,100%);
...
#tunnels[zoom >= 10] {
  ...
  ::fill {
    ...
    [feature = 'railway_INT-spur-siding-yard'][zoom >= 13] {
      [zoom < 13] {
        line-color: desaturate(#787878,100%);
        line-width: 0.5;
      ...
      [zoom >= 12] {
        #roads-fill, #bridges {
          ...
          [feature = 'railway_rail'] {
            dark/line-color: desaturate(#707070,100%);
            dark/line-width: 2;
          ...
          [feature = 'railway_INT-spur-siding-yard'] {
            dark/line-width: 2;
            dark/line-color: desaturate(#aaa,100%);
    ...
    [feature = 'railway_narrow_gauge'] {
      [zoom >= 8] {
        ...
        [zoom >= 13] { line-color: desaturate(#666,100%); }
        line-width: 1;
        [zoom >= 13] { line-width: 2; }
        #tunnels {
          line-dasharray: 5,3;
    ...
    [feature = 'railway_miniature'] {
      [zoom >= 15] {
        line/line-width: 1.2;
        line/line-color: desaturate(#999,100%);
        dashes/line-width: 3;
        dashes/line-color: desaturate(#999,100);
    ...
    [feature = 'railway_tram-service'][zoom >= 15] {
      [zoom >= 12] {
        line-color: desaturate(#6E6E6E,100%);
        line-width: 0.75;
        [zoom >= 14] {
          line-width: 1;
        }
    ...
    [feature = 'railway_preserved'] {
      [zoom >= 12] {
        ...
        [zoom >= 13] {
          dark/line-width: 3;
          dark/line-color: desaturate(#999999,100%);
          light/line-width: 1;
          light/line-color: white;
    ...
    [feature = 'railway_monorail'] {
      [zoom >= 14] {
        ...
        background/line-color: desaturate(#fff,100%);
        background/line-opacity: 0.4;
        background/line-cap: round;
        background/line-join: round;
        line/line-width: 3;
        line/line-color: desaturate(#777,100%);
...
#guideways {
  [zoom >= 11][zoom < 13] {
    line-width: 0.6;
    line-color: desaturate(#6699ff,100%);
...
#railways-text-name {
  ...
  [railway = 'tram'] {
    [zoom >= 17] {
      text-name: "[name]";
      text-fill: desaturate(#666666,100%);
      text-size: 10;
      text-dy: 6;
      text-spacing: 900;
      text-clip: false;
