#aerialways {
  ...
  [man_made = 'goods_conveyor'] {
    [zoom >= 14] {
      ...
      line/line-join: round;
      line/line-cap: round;
      line/line-color: desaturate(#999999,100%);

      dash/line-width: 2;
      dash/line-join: round;
      dash/line-color: desaturate(#999999,100%);
  ...
  [man_made = 'pipeline'] {
    [zoom >= 14] {
      line/line-width: .7;
      line/line-join: round;
      line/line-color: desaturate(#909090,100%);
      line/line-dasharray: 0,.7,14,.7;
      dash/line-width: 2;
      dash/line-join: round;
      dash/line-color: desaturate(#909090,100%);
      ...
      [zoom >= 17] {
        ...
        [substance = 'gas'] { center/line-color: desaturate(#c1c1c1,100%); } // Lch(78,0,0)
        [substance = 'oil'] { center/line-color: desaturate(#cfbfa5,100%); } // Lch(78,15,83)
      }
      [zoom >= 18] {
        line/line-width: 3;
