@admin-boundaries: desaturate(#8d618b,100%); // Lch(47,30,327)
@admin-boundaries-narrow: desaturate(#845283,100%); // Lch(42,35,327)
@admin-boundaries-wide: desaturate(#a37da1,100%); // Lch(57,25,327)
